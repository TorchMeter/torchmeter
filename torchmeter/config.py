    ...
    def asdict(self, safe_resolve: bool = False) -> Dict[str, CFG_CONTENT_TYPE]:
        ...
        for field in DEFAULT_FIELDS:
            ...
            if isinstance(field_val, FlagNameSpace):
                ...
                d[field] = [namespace_to_dict(v, safe_resolve=safe_resolve) if isinstance(v, FlagNameSpace) else v 
                            for v in field_val]
            elif isinstance(field_val, dict):
                d[field] = {k: namespace_to_dict(v, safe_resolve=safe_resolve) if isinstance(v, FlagNameSpace) else v 
